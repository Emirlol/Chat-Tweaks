...
object StringEqualityFilter: ChatTransformer {
	context(TransformerContext)
	override fun transform(input: Text): Text? = if (input.string.let { if (stripFormatting) Formatting.strip(it)!! else it }.equals(stringFilter, ignoreCase)) {
